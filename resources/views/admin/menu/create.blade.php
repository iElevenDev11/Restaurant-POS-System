        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-8">
                    <!-- Form Header -->
                    <div class="mb-8">
                        <h3 class="text-2xl font-bold text-gray-900 mb-2">Create New Menu Item</h3>
                        <p class="text-gray-600">Add a new item to your restaurant menu.</p>
                    </div>
                    ...
                    @if ($errors->any())
                        <div class="mb-6 bg-red-50 border border-red-200 rounded-md p-4">
                            <div class="flex">
                                ...
                                <div>
                                    <h4 class="text-sm font-medium text-red-800 mb-2">Please fix the following errors:
                                    </h4>
                        ...
                        <div class="bg-gray-50 rounded-lg p-6">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" name="is_available" id="is_available" value="1"
                                    @if (old('is_available', 1)) checked @endif
                                    class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                                <label for="is_available" class="ml-2 text-sm text-gray-700">
                                    Available for ordering
                                </label>
                            </div>
                            <p class="text-xs text-gray-500 mt-1">Check to mark this item as available for ordering</p>
                            @error('is_available')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
